...
const ManageComparisonWizard = () => {
  ...
  const handleEditComparison = async (researchProblem, lastDirectory, properties, comparisonId) => {
    ...
    try {
      const response = await axios.post('https://informed-manually-labrador.ngrok-free.app/api/edit-comparison', dataToSend);
  ...
  const handleAddComparison = async (researchProblem, lastDirectory) => {
    ...
    try {
      const response = await axios.post('https://informed-manually-labrador.ngrok-free.app/api/add-comparison', dataToSend);
